...
public abstract class ShaderProgram {
	...
	FloatBuffer maxtrixBuffer = BufferUtils.createFloatBuffer(16);
	...
	protected void loadMaxtrix(int location, Matrix4f mat) {
		
		mat.store(maxtrixBuffer);
		maxtrixBuffer.flip();
		GL20.glUniformMatrix4(location, false, maxtrixBuffer);
	}
	...
	private int loadShader(String file, int type) {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("Could not load the shader!");
			System.exit(-1);
		}
